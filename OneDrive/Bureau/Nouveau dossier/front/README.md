...
<p align="center">
  <a href="https://hopeui.iqonic.design/?utm_source=github&utm_medium=github-description&utm_campaign=open_source_github" target="__blank" title="Dispatcher">
...
<p align="center">
  <a href="https://templates.iqonic.design/hope-ui/html/dist" title="Dispatcher"><strong>Live Demo</strong></a>
  <span>|</span>
  <a href="https://www.figma.com/community/file/1009728454881721702" title="Dispatcher"><strong>Figma UI Kit</strong></a>
  <span>|</span>
  <a href="https://iqonic.design/product/admin-templates/hope-ui-admin-free-open-source-bootstrap-admin-template/?utm_source=github&utm_medium=github-description&utm_campaign=open_source_github" title="Dispatcher"><strong>HTML Dashboard</strong></a>
  <span>|</span>
  <a href="https://iqonic.design/product/admin-templates/hope-ui-open-source-vue-js-admin-template/?utm_source=github&utm_medium=github-description&utm_campaign=open_source_github" title="Dispatcher"><strong>Vue JS Dashboard</strong></a>
  <span>|</span>
  <a href="https://iqonic.design/product/admin-templates/hope-ui-free-open-source-react-admin-template/?utm_source=github&utm_medium=github-description&utm_campaign=open_source_github" title="Dispatcher"><strong>React JS Dashboard</strong></a>
  <span>|</span>
  <a href="https://iqonic.design/product/admin-templates/hope-ui-free-open-source-laravel-admin-panel/?utm_source=github&utm_medium=github-description&utm_campaign=open_source_github" title="Dispatcher"><strong>Laravel Dashboard</strong></a>
</p>

------------

<a href="https://templates.iqonic.design/hope-ui/html/dist" target="__blank" title="Dispatcher Dashboard">
  <img src="https://assets.iqonic.design/hope-ui/github/rtl-mode-min.png" alt="Dispatcher Dashboard" />
</a>

Dispatcher – free open source Bootstrap Design System is a gorgeously built UI kit based on bootstrap 5. The best free Bootstrap 5 design system is fully responsive and user-friendly, allowing Dispatcher users to work effortlessly.
Being easily adaptable and flexible, Dispatcher can be a go-to design system for the developer out there.

Looking up to creating a new application for a personal project or client? Dispatcher – free open source Bootstrap design system can help build a robust and understandable admin dashboard or website without spending much time designing the whole thing from scratch.

### What Can You Do with The Dispatcher

Dispatcher is packed with finely-crafted UI elements, multiple styles of Menu, a set of graphs, charts, and animated icons.
Built ideally for developers, designers, and startups, or Creators, Dispatcher brings design consistency and acts as a strong foundation to manage a successful web or app project.

### 5 Irresistible Reasons To Have Dispatcher
- Unlike any other Design System, Dispatcher is fully responsive which facilitates business owners to view the admin panel right from their mobile screens without losing the resolution.
...
- Besides being super easy and rapidly adaptable features, Dispatcher is the cost-effective way to control and overview web or app project performance with a pre-coded design system and examples.
- Dispatcher is a strongly built system, a layout that focuses on both the scalability and performance of the project.
- Dispatcher Packs 100+ Fully-Codes Elements and widgets backed with SCSS and Gulp to make the development easy and fast.
...
<a href="https://www.youtube.com/watch?v=3OMj6nqDuAA" title="Dispatcher" target="__blank">
  <img src="https://assets.iqonic.design/hope-ui/github/hope-ui-youtube.png" alt="Dispatcher Video" />
</a>
...
## Public RoadMap
Checkout our public roadmap of Dispatcher and also submit features requests [here](https://iqonic.design/hopeui-roadmap/).
## File Structure
