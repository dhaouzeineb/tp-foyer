                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/dashboard/app/device-list' ? 'active' : ''} nav-link`} to="/dashboard/app/device-list">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i className="sidenav-mini-icon"> U </i>
                                    <span className="item-name">Device list</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
                    ...
                    <Accordion.Collapse eventKey="sidebar-reclamation">
                        <ul>
                                ...
                                <Link className={`${location.pathname === '/dashboard/app/Reclamation' ? 'active' : ''} nav-link`} to="/dashboard/app/Reclamation">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
